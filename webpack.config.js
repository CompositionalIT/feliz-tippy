...
var htmlPlugin =
    new HtmlWebpackPlugin({
        filename: 'index.html',
        template: resolve('./src/SampleApp/index.html')
    });
...
var copyPlugin =
    new CopyWebpackPlugin({
        patterns: [{
            from: resolve('./src/SampleApp/public')
        }]
    });
...
var devServer = {
    publicPath: '/',
    contentBase: resolve('./src/SampleApp/public'),
    host: '0.0.0.0',
    port: 8080,
    hot: true,
    inline: true,
...
module.exports = {
    entry: { app: resolve('./src/SampleApp/SampleApp.fsproj') },
